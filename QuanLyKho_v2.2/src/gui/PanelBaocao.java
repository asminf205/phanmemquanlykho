...
public class PanelBaocao extends javax.swing.JPanel {
    ...
    private void print() {
        ...
        try {
            if (selectection == JFileChooser.APPROVE_OPTION) {
                ...
                pdfTable.setWidths(new int[]{50, 200, 120, 80, 80, 80, 80});
    ...
    private void initComponents() {
        ...
        grThongKe.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Tên SP", "Loại SP", "SL Nhập", "SL Xuất", "Tồn Kho"
            }
        ) {
        ...
        if (grThongKe.getColumnModel().getColumnCount() > 0) {
            ...
            grThongKe.getColumnModel().getColumn(1).setPreferredWidth(50);
            grThongKe.getColumnModel().getColumn(2).setPreferredWidth(50);
            grThongKe.getColumnModel().getColumn(3).setMinWidth(80);
            grThongKe.getColumnModel().getColumn(3).setPreferredWidth(80);
            grThongKe.getColumnModel().getColumn(3).setMaxWidth(80);
    ...
    private void initdata() {
        ...
        for (int l = 0; l < list2.size(); l++) {
            ...
            // String s = "S0000";
            // int s =15;
            //  for (int i = 0; i <= bc.countsoluongsp; i++) {
