...
public class PanelPhieu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Ok.png"))); // NOI18N
        jButton4.setText("Tạo phiếu");
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Cancel2.png"))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        /*  if (!txtMaPhieu.getText().trim().matches("P\\d{5}")) {
            JOptionPane.showMessageDialog(null, "Vui lòng nhập đúng dịnh dạng cho mã phiếu (PXXXXX)");
            return;
        }
        if (pnx.findID(txtMaPhieu.getText())) {
            JOptionPane.showMessageDialog(null, "Mã phiếu đã tồn tại !!");
            return;
        }
         */
        ...
        if (pnx.insert() > 0) {
            ...
            if (fk = true) {
                ...
                // String chuoi = txtMaPhieu.getText().trim();
                // int ma = Integer.parseInt(chuoi.substring(1));
                // ma++;
                // txtMaPhieu.setText("P" + String.format("%05d", ma));
